    ...
    namespace CurvedWorld
    {
        ...
        public class CurvedWorldController : MonoBehaviour
        {
            ...
            void UpdateShaderDataDisabled()
            {
                ...
                Shader.SetGlobalVector(materialPropertyID_BendSize, Vector4.zero);
                Shader.SetGlobalFloat(materialPropertyID_BendSize, 0);

                Shader.SetGlobalVector(materialPropertyID_BendOffset, Vector4.zero);
                Shader.SetGlobalFloat(materialPropertyID_BendOffset, 0);

                Shader.SetGlobalVector(materialPropertyID_BendAngle, Vector4.zero);
                Shader.SetGlobalFloat(materialPropertyID_BendAngle, 0);

                Shader.SetGlobalVector(materialPropertyID_BendMinimumRadius, Vector4.zero);
