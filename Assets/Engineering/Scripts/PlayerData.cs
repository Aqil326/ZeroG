...
public class PlayerData
{
	...
	public string previousName = "Astronaut";

    public bool licenceAccepted;
    // for that moment disabling tutorial feature
    // for this purpose commenting line number 386
    // That line stop reading tutorial done state from file
	...
	static public void NewSave()
	{
		...
		m_Instance.characters.Add("Astronaut");
		m_Instance.themes.Add("Jungle");
