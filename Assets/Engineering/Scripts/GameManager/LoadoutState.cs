...
public class LoadoutState : AState
{
    ...
    // This function helps to populate character on UI (illusion of showing on UI)
    // This function also populate theme section on main UI
    // This function also populates powerups if any have (purchased) on Screen
    public void Refresh()
    {
		PopulatePowerup();
    ...
    public override void Tick()
    {
        ...
        // }
		// if user have more than 1 character or theme
